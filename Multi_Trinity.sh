...
Trinity --seqType fq --max_memory $SLURM_MEM_PER_NODE --bflyCalculateCPU --left AllreadsTrimmed_1P.fq.gz,AllreadsTrimmed_1U.fq.gz --right AllreadsTrimmed_2P.fq.gz,AllreadsTrimmed_2U.fq.gz --SS_lib_type RF --CPU $SLURM_NTASKS_PER_NODE --normalize_reads --output /rhome/arajewski/shared/genetree/trinity_output_fabiana_rerun
